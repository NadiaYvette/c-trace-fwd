...
module Main -- Trace.Forward.Protocol.DataPoint.Codec
...
import Data.Aeson as Aeson hiding (decode')
...
printPretty :: Serialise a => a -> IO ()
printPretty = putStrLn . prettyHexEnc . wrapInMsgReply
  where
